...
The difficulty with Qt6 build (which is the default), is sometimes to get the `lrelease` executable
- lrelease

By chance, the compilation should work even if theses 2 tools is supposed to work with Qt5.
