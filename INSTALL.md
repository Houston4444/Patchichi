...
The difficulty with Qt6 build (which is the default), is sometimes to get the `lrelease` executable. By chance, the compilation should work even if this tool is supposed to work with Qt5.
